...
{
    /// <summary>
    /// Class which abstracts all other classes with ability to request navigation and to change dynamic content.
    /// </summary>
    /// <typeparam name="T">Type of data associated with content change.</typeparam>
    public abstract class NavigationDynamicContent<T>: NavigationSource, IDynamicContent<T>
    {
